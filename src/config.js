...
module.exports = {
  ...
  description:
    "Passionate software engineer, especially experienced in mobile application development for 3.5 years and other software development in the IT industry in Mongolia. Professional at the whole mobile application development process from the blank project to release and launch to public application stores and the maintenance, which includes designing, developing and testing. And I'm very keen to study advanced computer science, especially artificial intelligence and data science.",
  contact: [
    {
      key: "Email",
